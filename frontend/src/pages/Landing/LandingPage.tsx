...
export const LandingPage = () => {
  ...
  const [landingPageSubpage, setLandingPageSubpage] = useState<string>("home");
  ...
  const links: Array<MenuItemType> = [
    {
      ...
      onClick: () => {setLandingPageSubpage("home")}
    },
    {
      key: 2,
      label: "Overview",
      ...
      onClick: () => {setLandingPageSubpage("overview")}
    },
    {
      key: 3,
      label: "Signup",
      ...
      onClick: () => {setLandingPageSubpage("signup")}
    },
    {
      key: 4,
      label: "Log In",
